        ...
        <div class="col-lg-4 col-md-6">
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <a class="avatar" href="javascript:void(0);"><img src="{{Storage::disk('public')->url('profile/'.$post->user->images)}}" alt="Profile Image"></a>
                ...
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-info">
                            ...
                            <h4 class="title"><strong>Sorry, No post Found :(</strong></a></h4>
